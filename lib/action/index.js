...
var ManifestActionComponent = function (_React$Component) {
  ...
  _createClass(ManifestActionComponent, [{
    ...
    value: function getDiffs() {
      ...
      var previousState = _props.previousState;

      return (0, _diffState2.default)(currentState, previousState).map(function (d, i) {
    ...
    value: function render() {
      ...
      var action = _props2.action.action;
      var skipped = _props2.skipped;
      ...
      var storeBlock = expanded ? _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            {
              ...
              style: [_style2.default.title, skipped && _style2.default.skipped],
