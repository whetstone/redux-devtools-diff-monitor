...
var ManifestComponent = (function (_Component) {
  ...
  ManifestComponent.prototype.componentDidMount = function componentDidMount() {
    ...
    var shortcutKeys = this.props.shortcutKeys;
  ...
  _createClass(ManifestComponent, null, [{
    ...
    value: {
      ...
      shortcutKeys: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.arrayOf(_react2['default'].PropTypes.number)]),
      ...
      jumpToState: _react.PropTypes.func.isRequired // ({ index })
    },
    enumerable: true
  }, {
    key: 'defaultProps',
