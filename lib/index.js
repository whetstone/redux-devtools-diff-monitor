...
var ManifestComponent = (function (_React$Component) {
  ...
  ManifestComponent.prototype.render = function render() {
    ...
    if (visible) {
      _style2['default'].base.display = 'none';
    }
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(_button2['default'], { label: 'Commit', action: this.props.commit.bind(this) }),
        _react2['default'].createElement(_button2['default'], { label: 'Rollback', action: this.props.rollback.bind(this) }),
        _react2['default'].createElement(_button2['default'], { label: 'Reset', action: this.props.reset.bind(this) })
      ),
