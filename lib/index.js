...
var ManifestComponent = (function (_React$Component) {
  ...
  ManifestComponent.prototype.renderAction = function renderAction(action, index) {
    var newState = undefined,
        ...
        diff = undefined;
    if (index !== 0) {
      newState = _immutable2['default'].Map(this.props.computedStates[index].state).toObject();
      oldState = _immutable2['default'].Map(this.props.computedStates[index - 1].state).toObject();
